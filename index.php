...
$banco = "SELECT * FROM musicatiabela where Musica LIKE '%$texto%'";
                        ...
                        <div class='card shadow-sm'>
                           <div class='audio'>
                                <audio class='musica' id='son1' controls poster='' >
                                 ...
                                 <source src='musicas/$resultado[Musica]' type='audio/x-aac'>
                                 <source src='musicas/$resultado[Musica]' type='audio/ogg'>
...
//$banco1 = "SELECT * FROM musicatiabela WHERE Novo = 1";
...
$query = "SELECT * FROM musicatiabela ORDER BY Nome ASC LIMIT {$por_pagina} OFFSET {$ofset}";
                    ...
                    <div class='card shadow-sm'>
                       <div class='audio' >
                            <audio data-file='musicas/$paginas[Musica]' class='musica' controls poster='' id='son1' >
                             ...
                             <source src='musicas/$paginas[Musica]' type='audio/x-aac'>
                             <source src='musicas/$paginas[Musica]' type='audio/ogg'>
