...
$banco = "SELECT * FROM musicatiabela where Data1 LIKE '2021%' AND Musica like '%$texto%' ORDER BY Data1 DESC";
...
$query = "SELECT * FROM musicatiabela WHERE Data1 LIKE '2021%' ORDER BY Data1 DESC LIMIT {$por_pagina} OFFSET {$ofset}";
