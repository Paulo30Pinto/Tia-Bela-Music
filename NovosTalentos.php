...
$banco = "SELECT * FROM musicatiabela where Novo=1 AND Musica LIKE '%$texto%'";
...
$query = "SELECT * FROM musicatiabela WHERE Novo = 1 ORDER BY Id ASC LIMIT {$por_pagina} OFFSET {$ofset}";
