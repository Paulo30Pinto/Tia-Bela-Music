...
$banco = "SELECT * FROM musicatiabela where Destaques >= 1 AND Destaques <= 3 AND Musica like '%$texto%' ORDER BY Destaques ASC";
...
$query = "SELECT * FROM musicatiabela WHERE Destaques >= 1 AND Destaques <= 3 ORDER BY Destaques ASC LIMIT {$por_pagina} OFFSET {$ofset}";
