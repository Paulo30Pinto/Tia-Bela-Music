...
$banco = "SELECT * FROM musicatiabela where Genero IN('Kuduro','Afro House') AND Musica like '%$texto%'";
...
$query = "SELECT * FROM musicatiabela WHERE Genero = 'Kuduro' OR Genero = 'Afro House' ORDER BY Id ASC LIMIT {$por_pagina} OFFSET {$ofset}";
