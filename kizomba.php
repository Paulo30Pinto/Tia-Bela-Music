...
$banco = "SELECT * FROM musicatiabela WHERE Genero IN('Kizomba','Semba') AND Musica like '%$texto%'";
...
$query = "SELECT * FROM musicatiabela WHERE Genero = 'Kizomba' OR Genero = 'Semba' ORDER BY Id ASC LIMIT {$por_pagina} OFFSET {$ofset}";
