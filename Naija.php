...
$banco = "SELECT * FROM musicatiabela WHERE Genero = 'Naija' AND Musica like '%$texto%'";
...
$query = "SELECT * FROM musicatiabela WHERE Genero = 'Naija' ORDER BY Id ASC LIMIT {$por_pagina} OFFSET {$ofset}";
