...
$banco = "SELECT * FROM musicatiabela WHERE Genero IN('Rap','HipHop','RNB') AND Musica like '%$texto%'";
...
$query = "SELECT * FROM musicatiabela WHERE Genero IN('Rap','HipHop','RNB') ORDER BY Id ASC LIMIT {$por_pagina} OFFSET {$ofset}";
